...
public final class BillingServiceGrpc {
  ...
  private static volatile io.grpc.MethodDescriptor<billing.BillingRequest,
      billing.BillingResponse> getCreateBillingMethod;

  @io.grpc.stub.annotations.RpcMethod(
      fullMethodName = SERVICE_NAME + '/' + "CreateBilling",
  ...
  public static io.grpc.MethodDescriptor<billing.BillingRequest,
      billing.BillingResponse> getCreateBillingMethod() {
    io.grpc.MethodDescriptor<billing.BillingRequest, billing.BillingResponse> getCreateBillingMethod;
    if ((getCreateBillingMethod = BillingServiceGrpc.getCreateBillingMethod) == null) {
      synchronized (BillingServiceGrpc.class) {
        if ((getCreateBillingMethod = BillingServiceGrpc.getCreateBillingMethod) == null) {
          BillingServiceGrpc.getCreateBillingMethod = getCreateBillingMethod =
              io.grpc.MethodDescriptor.<billing.BillingRequest, billing.BillingResponse>newBuilder()
              .setType(io.grpc.MethodDescriptor.MethodType.UNARY)
              .setFullMethodName(generateFullMethodName(SERVICE_NAME, "CreateBilling"))
              .setSampledToLocalTracing(true)
              .setRequestMarshaller(io.grpc.protobuf.ProtoUtils.marshaller(
                  billing.BillingRequest.getDefaultInstance()))
              .setResponseMarshaller(io.grpc.protobuf.ProtoUtils.marshaller(
                  billing.BillingResponse.getDefaultInstance()))
              .setSchemaDescriptor(new BillingServiceMethodDescriptorSupplier("CreateBilling"))
              .build();
        }
      }
    }
    return getCreateBillingMethod;
  }
  ...
  public interface AsyncService {
    ...
    /**
     */
    default void createBilling(billing.BillingRequest request,
        io.grpc.stub.StreamObserver<billing.BillingResponse> responseObserver) {
      io.grpc.stub.ServerCalls.asyncUnimplementedUnaryCall(getCreateBillingMethod(), responseObserver);
    }
  }
  ...
  public static final class BillingServiceStub
    ...
    /**
     */
    public void createBilling(billing.BillingRequest request,
        io.grpc.stub.StreamObserver<billing.BillingResponse> responseObserver) {
      io.grpc.stub.ClientCalls.asyncUnaryCall(
          getChannel().newCall(getCreateBillingMethod(), getCallOptions()), request, responseObserver);
    }
  }
  ...
  public static final class BillingServiceBlockingStub
    ...
    /**
     */
    public billing.BillingResponse createBilling(billing.BillingRequest request) {
      return io.grpc.stub.ClientCalls.blockingUnaryCall(
          getChannel(), getCreateBillingMethod(), getCallOptions(), request);
    }
  }
  ...
  public static final class BillingServiceFutureStub
    ...
    /**
     */
    public com.google.common.util.concurrent.ListenableFuture<billing.BillingResponse> createBilling(
        billing.BillingRequest request) {
      return io.grpc.stub.ClientCalls.futureUnaryCall(
          getChannel().newCall(getCreateBillingMethod(), getCallOptions()), request);
    }
  }

  private static final int METHODID_CREATE_BILLING = 0;
  ...
  private static final class MethodHandlers<Req, Resp> implements
    ...
    public void invoke(Req request, io.grpc.stub.StreamObserver<Resp> responseObserver) {
      switch (methodId) {
        case METHODID_CREATE_BILLING:
          serviceImpl.createBilling((billing.BillingRequest) request,
              (io.grpc.stub.StreamObserver<billing.BillingResponse>) responseObserver);
          break;
        default:
  ...
  public static final io.grpc.ServerServiceDefinition bindService(AsyncService service) {
    return io.grpc.ServerServiceDefinition.builder(getServiceDescriptor())
        .addMethod(
          getCreateBillingMethod(),
          io.grpc.stub.ServerCalls.asyncUnaryCall(
            new MethodHandlers<
              billing.BillingRequest,
              billing.BillingResponse>(
                service, METHODID_CREATE_BILLING)))
        .build();
  }
      ...
      synchronized (BillingServiceGrpc.class) {
        ...
        if (result == null) {
          serviceDescriptor = result = io.grpc.ServiceDescriptor.newBuilder(SERVICE_NAME)
              ...
              .addMethod(getCreateBillingMethod())
              .build();
        }
      }
    }
